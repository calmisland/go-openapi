...
[![GoDoc](https://godoc.org/github.com/calmisland/go-openapi?status.svg)](https://godoc.org/github.com/getkin/kin-openapi)
...
# Structure
  * _openapi2_ ([godoc](https://godoc.org/github.com/calmisland/go-openapi/openapi2))
    * Support for OpenAPI 2 files, including serialization, deserialization, and validation.
  * _openapi2conv_ ([godoc](https://godoc.org/github.com/calmisland/go-openapi/openapi2conv))
    * Converts OpenAPI 2 files into OpenAPI 3 files.
  * _openapi3_ ([godoc](https://godoc.org/github.com/calmisland/go-openapi/openapi3))
    * Support for OpenAPI 3 files, including serialization, deserialization, and validation.
  * _openapi3filter_ ([godoc](https://godoc.org/github.com/calmisland/go-openapi/openapi3filter))
    * Validates HTTP requests and responses
  * _openapi3gen_ ([godoc](https://godoc.org/github.com/calmisland/go-openapi/openapi3gen))
    * Generates `*openapi3.Schema` values for Go types.
  * _pathpattern_ ([godoc](https://godoc.org/github.com/calmisland/go-openapi/pathpattern))
